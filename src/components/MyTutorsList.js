...
export default function MyTutorsList() {
    ...
    <div className="w-full bg-base-100 py-12 px-6 sm:px-8 max-w-6xl mx-auto flex-grow">
      ...
      {tutors.length === 0 ? (
        <EmptyState
          ...
          description="You haven't listed any tutor profiles yet. Publish your subject specialist details and start receiving active student slots!"
          actionText="Create Tutor Profile"
                  ...
                  <td className="py-4">
                    <div className="flex items-center gap-3">
                      <div className="avatar">
                        <div className="w-11 h-11 rounded-xl overflow-hidden bg-base-200 ring-1 ring-base-300 relative">
                          <Image
                            src={tutor.photoUrl}
                            alt={tutor.name}
                            fill
