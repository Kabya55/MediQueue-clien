...
export default function MyBookedSessionsList() {
    ...
    <div className="w-full bg-base-100 py-12 px-6 sm:px-8 max-w-5xl mx-auto flex-grow">
      ...
      {bookings.length === 0 ? (
        <EmptyState
          ...
          description="You haven't scheduled any classes yet. Browse our professional instructors list and book your slot today!"
          actionText="Find Elite Tutors"
          actionLink="/tutors"
